package com.nextbyte.controller;
...
/**
 * 由于接口资源地址没有在Spring Security配置中放开，因此三个接口访问都需要传入accessToken。
 * 其中，messages1接口的要求只需传入accessToken，messages2接口要求传入accessToken和拥有profile权限，messages3接口要求传入accessToken和拥有Message权限，而message4接口是新增的一个，试试用户的这个权限访问结果
 */
@RestController
